...
#' @title Adds txt and zip file paths to the filenames attribute, then writes a json file.
#' @description Writes the txt and json dumps of raw data used in the job, png files of the
